...
class WideResNet(nn.Module):
    def __init__(self, args, depth=28, widen_factor=10, drop_rate=0.0, return_features=True):
        ...
        self.conv1 = nn.Conv2d(3, channels[0], kernel_size=3, stride=2, padding=1, bias=True)
        # 1st block
        self.block1 = self._make_layer(n, channels[0], channels[1], 2, drop_rate, activate_before_residual=True)
        # 2nd block
...
def WRN28(args):
    return WideResNet(args,depth=28, widen_factor=10)
